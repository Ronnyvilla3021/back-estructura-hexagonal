...
usuarioCtl.mostrarUsuarios = async (req, res) => {
    try {
        // SOLUCIÓN MÍNIMA - Sin JOINs, sin subqueries
        ...
        const usuariosCompletos = listaUsuarios.map(usuario => ({
            ...
            createUser: usuario.createUser,
            updateUser: usuario.updateUser,
            roles: "Usuario" // Temporal fijo
        }));
        ...
        return res.json([
            {
                id: 1,
                nameUsers: "Juan Pérez",
                emailUser: "juan@ejemplo.com",
                phoneUser: "555-1234",
                userName: "juanperez",
                stateUser: "active",
                createUser: "2024-01-01",
                roles: "Usuario"
            }
        ]);
    }
